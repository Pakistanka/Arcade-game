...
var Enemy = function(x, y) {
    ...
    /*I am making this a SUGGESTED fix because you could argue that multiplier acts as a speed property -- although I'm guessing you intended it to be a multiplier for the true speed, which is 40 in your code below:
    this.x = this.x + 40 * dt * this.multiplier;
    really should be:
    this.x = this.x + this.speed * dt * this.multiplier;*/
};
